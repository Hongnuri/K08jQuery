...
<body>
	<div class="container">
		...
		<div class="form-group">
			<label for="email">가격 :</label> <input type="text"
				class="form-control" id="price" value="100000" />
		</div>
		<br />
		<div class="form-group">
			<label for="email">상품명 :</label> <input type="text"
				class="form-control" id="name" value="노트북" />
		</div>
		<br />
		<div class="d-flex justify-content-center">
			<button type="button" id="Button01"
				class="btn btn-primary text-center">Get으로전송</button>
			&nbsp;&nbsp;
